...
INSERT INTO fd_brand (slug, name, tokens_json, voice_json, created_at) VALUES ('omnissa', 'Omnissa', '{"color":{"bg":"#F5F5F7","surface":"#FFFFFF","ink":"#28334A","ink-strong":"#001E60","muted":"#616899","accent":"#4A12F0","on-accent":"#FFFFFF","signal":"#C9FF27","on-signal":"#001E60","line":"#D9D9E4","line-strong":"#B6B9D0","danger":"#B02A37","success":"#146C43"},"fontDisplay":"''Outfit Variable'', ''Outfit'', sans-serif","fontBody":"''Outfit Variable'', ''Outfit'', sans-serif","fontUtility":"''IBM Plex Mono'', ui-monospace, monospace","radius":"6px","logoUrl":""}', '{"greeting":"Built for how People teams actually work.","signoff":"Independent demonstration. Not affiliated with or endorsed by Omnissa."}', '2026-08-07T23:45:47.630Z');
INSERT INTO fd_brand (slug, name, tokens_json, voice_json, created_at) VALUES ('verdant', 'Verdant Collective', '{"color":{"bg":"#F2F4EF","surface":"#FBFCF9","ink":"#25332B","ink-strong":"#152219","muted":"#5E7266","accent":"#2F6B4F","on-accent":"#FFFFFF","signal":"#FFB84D","on-signal":"#152219","line":"#D4DCD2","line-strong":"#AFBDB1","danger":"#A33B2E","success":"#2F6B4F"},"fontDisplay":"Georgia, ''Times New Roman'', serif","fontBody":"-apple-system, ''Segoe UI'', system-ui, sans-serif","fontUtility":"''Courier New'', ui-monospace, monospace","radius":"14px","logoUrl":""}', '{"greeting":"Grow judgment, not just skills.","signoff":"Verdant Collective is a fictional brand used to prove the theming system."}', '2026-08-07T23:45:47.630Z');
INSERT INTO fd_access_code (id, brand_slug, code_hash, label, max_uses, uses, expires_at, active) VALUES ('580127fc-f5f4-4fef-b87f-feee7078f5d4', 'omnissa', 'pbkdf2$100000$brJK/zHtyGpN1ssfOqyEkw==$ay+43GMP6oVC37sj44B9DHb8zMNG/tY/74iqEs+JaOA=', 'Reviewer 1 · Omnissa', NULL, 0, NULL, 1);
INSERT INTO fd_access_code (id, brand_slug, code_hash, label, max_uses, uses, expires_at, active) VALUES ('e03b1845-47eb-4a77-ab34-6722e8e1283b', 'verdant', 'pbkdf2$100000$jcdIWUUo+EED7uqPOwi4Zw==$ORvxcRPs7hheKyrxlKt3HVD/lbfbXsdlwOl1aC6IOiQ=', 'Theming proof', NULL, 0, NULL, 1);
