...
// The podcast, embedded in the module page — the episode lives where the
// learning happens, not on a separate "studio" page.
...
export default function PodcastPanel({ moduleId }: { moduleId: string }) {
  ...
  return (
    <div>
      <p className="text-ink text-sm mt-2 max-w-xl">
