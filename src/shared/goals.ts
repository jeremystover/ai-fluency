...
export const GOAL_CHOICES: GoalChoice[] = [
  {
    ...
    detail: "The working mental model — what AI is, what it isn't, and when to trust it with People work. Everything else stands on this.",
  ...
  },
  {
    ...
    detail: 'Swap the vague anxiety for a working model. Two modules in, the headlines — and the vendor pitches — start making sense.',
