# AI 401 · The Translator · Module 1 — Load paths

**Course:** AI 401 · The Translator · Module 1 of 10
**Estimated time:** 20 min content · 10 min exercise · 25 min applied activity
**Prerequisite:** AI 101, AI 201, and a 301 role track — all advisory, none enforced
**Position in the course:** the framing, and the shortest module here on purpose

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> Lessons 1 and 2 are **[V]** volatile layer — they carry this course's two anchor studies. The
> mental model in Lessons 3 and 4 is stable and is the thing you keep.
...
places where it decides something. Lesson 4 says where each piece went.
...
3. Distinguish structures that hold weight from decorative ones — and explain why the decisive ones
   are usually undesigned.
4. Explain why this course's deliverable is a spec with a tolerance rather than a plan with a date.
5. Name one structure in your own organization that AI is currently removing.

## Lesson 1 · Where the variance actually lives **[V]**
...
## Lesson 3 · What holds the weight
...
structural, specify the structure, and set tolerances for loads that can't be predicted
...
structural are the ones nobody designed.** That isn't a paradox. Designed structures get
...
**Nothing was destroyed. Something was removed that nobody had written down as structural.**
...
| Middle managers as the point where the whole thing gives | Module 5, where their absorbed work is what the audit finds |
...
from anything you were building. That is the trade, stated so you can disagree with it.
...
- **The structures most likely to be holding something up are the ones nobody designed** — because
...
- **A spec with a trigger can be wrong in a way you would notice. A vision statement cannot.**

## Take a position

**The claim:** *"The structures most likely to be holding something up are the ones nobody designed."*
...
lose. Sharper still: **"structural" and "should be structural" are different claims, and
this lesson quietly slides from the first to the second.**

Your position has to say what you would do about a structure that's genuinely holding something up *and*
...
was holding something up, that nobody designed, and that AI is removing, weakening, or making optional
...
counter-argument above rather than restating the claim.

## Knowledge check — 8 questions

*Unlocks after the applied activity is submitted. Retakes are free and unlimited.*

**Q1.** What is the course's central thesis?
...
- A. The cost of retraining a workforce after a technology change
- B. The gap between what an organization says about AI and what it does
- C. The cost an organization takes on when it scales AI faster than the norms, trust, and accountability structures around it ✓
- D. Employee resistance that accumulates when change is poorly communicated

> **C.** Like technical debt: invisible in the quarter you incur it, expensive in the one where
> you pay. The 42% who say their organization rarely evaluates AI's impact on people is the
> measurement gap that lets it accumulate.

**Q4.** Why does the module argue that undesigned structures are the ones most likely to be holding something up?

- A. Because informal structures are usually more efficient than formal ones
- B. Because designed structures get documented, documented structures get defended, and undesigned ones have no owner or advocate, so nothing in the process notices when they go ✓
- C. Because organizations systematically under-invest in process design
- D. Because coordination work is harder to design than production work

> **B.** It is a claim about *what happens when something is removed*, not about which kind of
> structure is better.

**Q5.** Why is AI unusually good at removing this specific category of structure?
...
**Q6.** What does "tolerances, not drawings" mean in practice?

- A. That plans should be revised quarterly rather than annually
- B. That leaders should set targets rather than prescribe methods
- C. That you specify what must hold and how much variation it can absorb, rather than specifying the destination ✓
- D. That change programs should be piloted before they are scaled
...
**Q8.** Why does the course distribute change-management content rather than give it a module?
...
- The load-path model, the decisive/decorative distinction, the claim that undesigned
  structures are the ones most likely to be holding something up, and the tolerances-not-drawings framing
  are original to this course.
- Builds on 101 M1 (the delegation heuristic) and 201's shipped build, and assumes a 301 role
  track without depending on which one.
