...
employees actually don't understand. Not what they say in a survey when asked a question you wrote
...
thousand unstructured strings wasn't a thing a communications team could do.
...
something specific enough to type it and didn't get it. No survey produces information that clean.
...
quarters. A question asked three quarters running isn't a question; it is a finding.
...
needed, unbidden, which means it isn't shaped by what you already thought to ask, and the things
...
you pay for. It isn't a purchase. It is a request.

> ### Try this — 3 minutes
> Write down the three things you're most confident your workforce understands about a recent
...
**The interpretation trap.** Give a model four hundred tickets and ask for themes, and you'll get
themes. Five of them, cleanly named, plausibly distributed, with representative quotes. You'll get
...
The model isn't lying. Thematic synthesis is a task with no natural failure signal. There is no
...
**Ask what does not fit.** A model asked for themes will assign everything. A model asked "what
...
manager" isn't a statistical error. It may be entirely accurate. It is a disclosure. The manager
reading it knows who the two silent ones probably are. And the promise made at fielding time said
this wouldn't happen.

The fix isn't a confidence interval. It is a **reporting floor**, a minimum cell size below which
results aren't reported at all, decided in advance, applied without exception, and stated in the
promise itself. Set before you see the data, because a floor you can waive when the finding is
interesting isn't a floor.
...
The text of the prohibition doesn't itself say "biometric." But the European Commission's guidance
...
- **Sentiment scoring of Slack messages or survey verbatims.** Text isn't biometric data. Very
...
**First, the thing everyone assumes is banned mostly is not** — which means "we can't, it's illegal
in the EU" isn't available to you as a reason, and if you have been using it, you have been winning
...
**These are notice regimes, not consent regimes.** They don't prohibit monitoring; they require you
to have said you were doing it. Which turns the practical question into a specific and checkable
one: **does the notice your employees actually acknowledged cover what you're proposing to build?**
A notice from 2019 saying "telephone, email and internet usage may be monitored" isn't obviously a
notice that you'll run sentiment inference across internal chat. That is a question for counsel,
...
You won't resolve four regimes, in every jurisdiction you operate in, from a module. What you can
...
Capability arriving after the promise doesn't amend the promise. If the survey said responses are
anonymous and reported only in aggregate, then a model that could now identify patterns by team does
not get to, and the fact that it is technically trivial isn't an argument. This isn't a legal
...
- **The promise you made when you fielded it governs what you may do with the answers.** Capability
  arriving later doesn't amend it.
...
sentiment" isn't a question; "which three things did people search for and not find after the
...
> **B.** Ask for four hundred tickets to be themed and you'll get themes, whether or not themes exist. The three cheap defences: ask for the distribution, ask what did not fit and how much, and run it twice to see whether the structure holds.
...
> **B.** The prohibition's text does not say "biometric," but Commission guidance ties it to the Act's defined term, which is limited to inference from biometric data. In force since 2 February 2025 and absolute, with narrow medical and safety exceptions.

**Q5.** What is the practical consequence of "not prohibited isn't cleared"?
...
> **B.** And it cuts the other way too: "we cannot, it's illegal in the EU" is not available as a reason for text analysis, so anyone who has been using it has been winning an argument on a premise that will not survive the first person who checks.

**Q6.** New York, Connecticut and Delaware require what, precisely `[V]`?

- A. Employee consent before any electronic monitoring
- B. Notice: written or electronic, with acknowledgment and in some cases conspicuous posting. They don't prohibit monitoring; they require you to have said you were doing it ✓
...
> **C.** A team that built its rules around the memo now has rules with no foundation. A team that built them around "do not build systems that would tend to chill protected concerted activity" has rules exactly as valid as before, and still valid when the posture flips back.

**Q8.** What is the strongest argument *against* the promise-based rule?

- A. That employees don't read privacy notices, so the promise has no effect
...
- C. That anonymity can't be guaranteed in any dataset
