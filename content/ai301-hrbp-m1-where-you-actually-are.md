# AI 301 · HRBP · Module 1 — Where you actually are

**Course:** AI 301 · The Specialist — HRBP track · Module 1 of 7
**Estimated time:** 20 min content · 5 min exercise · 15–20 min applied activity
**Prerequisite:** AI 101 (or the diagnostic test-out). AI 201 recommended.
**Position in the track:** first, and deliberately short — it changes how everything after it lands.

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> Every adoption statistic here is **[V]** volatile layer. The survey that produced them is
> annual; the numbers will move and the structure they reveal probably won't.
...
## Lesson 1 · The anxiety, and where it comes from **[V]**
...
motivated to publish are the ones with something to sell or something to celebrate.**
...
and the one thing you now think you should stop worrying about.

## Knowledge check — 5 questions

*Unlocks after the applied activity is submitted. Retakes are free and unlimited.*

**Q1.** Why does the publicly available picture of AI adoption in HR skew toward success and completion?

- A. Publications are legally required to report only verified implementations
- B. The people motivated to publish are vendors, consultancies, and practitioners with a win to describe — nobody publishes the ambiguous result, which is the modal one ✓
- C. Failed implementations are rare enough that they don't affect the average
- D. Survey methodology in HR research systematically oversamples large organizations

> **B.** A selection effect, not a conspiracy: the content environment is assembled from the
> subset of experiences someone had a reason to publicize. C is contradicted by the
> business-value data, and D describes a different problem than the one this lesson is about.

**Q2.** A large majority of HR leaders report their organizations have not realized significant business value from AI tools. What does this most directly indicate?

- A. That AI tools do not work for HR use cases
- B. That the surveyed organizations have not adopted AI at all
- C. That adoption and payoff are separate milestones, and most of the field currently sits in the gap between them ✓
- D. That HR leaders are poor judges of business value

> **C.** The finding is about the distance between two milestones, not about the technology's
> ceiling. B confuses this statistic with the no-plans figure; A over-reads a snapshot of an
> early field.
...
- A. Adopting what's marketed rather than what fits your function
- B. Mistaking pilots launched for progress
- C. Buying before you can evaluate
- D. Skipping the baseline ✓

> **D.** Without a before-number, a working implementation and a useless one are
> indistinguishable afterward — and the case for your function in Module 7 cannot be built at
> all. B is a related error but it substitutes a bad metric rather than eliminating the
> possibility of a good one.

**Q5.** What does this module actually argue about urgency?

- A. That the technology is overhyped and HR functions should wait for it to mature
- B. That you have more room to be deliberate than the content environment suggests, and deliberateness is what separates implementations that survive from ones that get retired ✓
- C. That market pressure on the HRBP role is exaggerated and can be safely discounted
...
- **The AI Fluency Framework** (Rick Dakan & Joseph Feller, in collaboration with Anthropic,
  CC BY-NC-SA 4.0) — the calibrated-judgment stance this module's prediction gate serves.
