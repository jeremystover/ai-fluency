# AI 301 · HRBP · Module 2 — Sort your own job

**Course:** AI 301 · The Specialist — HRBP track · Module 2 of 7
**Estimated time:** 40 min content · 10 min exercise · 20–25 min applied activity
**Prerequisite:** Module 1 · builds on 101 M1 (the delegation heuristic) and 201 M1 (the workflow audit)
**Position in the track:** the map everything after it is drawn on

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> Adoption figures and analyst projections are **[V]** volatile layer. The two-question test is
> stable — it would have worked before these tools existed and will outlive their current shape.
...
5. Describe the analyst consensus on HR headcount and ratios honestly enough to plan against it.

## Lesson 1 · Two questions, four quadrants
...
partly reflects low tractability rather than high protection — and tractability changes.

## Lesson 3 · Least penetrated is not protected
...
compression argument proves less than it appears to.

## Applied activity — "One week, sorted"
...
> **B.** Contest means reasonable people could defensibly disagree, not that the work is hard.
> A determinate calculation with one right answer is difficult and uncontested — which is
> precisely the profile where AI assistance is most valuable and least fraught.

**Q3.** Across HR practice areas `[V]`, where has AI adoption actually concentrated?
...
> plausible but is a slower and less certain mechanism than the one that's already operating.
...
> opposite of most people's intuition about it.

**Q6.** Gartner's projection `[V]` is that the HRBP ratio could move from roughly one per 423 employees to:

- A. One per 500–600 within a decade
- B. One per 800–1,200 within one to five years ✓
- C. One per 2,000 within two years
- D. No change in ratio, with the role's content shifting instead
...
> compression determines coverage. B is worth noticing but it's an ad hominem about the source
> rather than an argument about the mechanism, and two independent firms agreeing weakens it.
...
> **B.** The compression is the argument *for* the rest of the track: use AI to buy back the
> hours that currently prevent you from being the consultative practitioner the strategic talent
> leader model describes. A defends the queue, which is the losing position; C abandons the
> quadrant where this role's actual value sits.
