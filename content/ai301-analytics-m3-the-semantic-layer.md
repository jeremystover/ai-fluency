...
to say what happens to a question the semantic layer does not cover, and who finds out.
...
- A. Models introduce new ambiguities that did not exist in dashboards
...
- A. Because errors are logged and resolutions are not
...
- A. That AI-generated analyses cannot be reproduced
...
- D. That verification tooling has not kept pace with generation tooling
