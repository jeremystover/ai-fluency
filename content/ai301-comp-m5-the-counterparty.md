# AI 301 · Comp & Benefits · Module 5 — The counterparty

**Course:** AI 301 · The Specialist — Comp & Benefits track · Module 5 of 6
**Estimated time:** 45 min content · 10 min exercise · 30 min applied activity
**Prerequisite:** Modules 1–4 · builds on Module 2 (reading evidence) and Module 4 (the circular zone)
**Position in the track:** the uncomfortable one, which is why it sits at five rather than two

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> Lessons 1–3 are **[V]** volatile — survey figures, an audit tied to specific model versions, and
> an institutional investing practice that is changing quarter to quarter.
...
> **Your pay story is already being audited by a model. You just haven't read the report.**
...
5. Build a pay rationale that survives an adversary holding the same tools.

## Lesson 1 · The employee side **[V]**
...
## Lesson 2 · And the briefing is unreliable **[V]**
...
happens to have come from studying your counterparty.
...
> next negotiation whether or not you looked at it.

## Lesson 3 · The third counterparty **[V]**
...
shift. One that depended on complexity absorbing scrutiny loses.

## Lesson 4 · What survives contact
...
on the cost of verification, and the module's uncomfortable question is which one you are.
...
- **The cost of checking you is now approximately zero.** A well-designed program gains from that.
  A story that relied on verification being expensive does not.
...
> **B.** The sample is the finding, which is Module 2's whole method applied to a number this
> course itself uses. You will see this quoted as A, and A is wrong.
...
> **B.** Convergence is what makes a counterparty predictable. What works instead isn't a script,
> it's the ability to say where your number comes from in a form that survives checking.

**Q3.** What was the largest source of variation in the negotiation-advice audit? `[V]`

- A. Gender of the profile in the prompt
- B. The candidate's stated years of experience
- C. Differences between model versions, and between prompts voiced as the employee versus the employer ✓
- D. The geographic market named in the prompt

> **C.** Gender effects were statistically significant in all four versions and *smaller* than
> these. The employee/employer voicing gap means **the same model gives the two sides of your
> negotiation different numbers**, and neither party can see the other's framing.
...
> **B.** This is the evidence behind *describe your pay patterns, don't recommend your pay
> decisions*. C treats a validity problem as a variance problem.
...
> **B.** A is backwards — advisor influence appears to be declining as investors build in-house
> approaches. Your disclosure is no longer competing for attention; it's being compared.
...
> **B.** A well-designed program with a clearly written explanation gains from this. One that
> depended on complexity absorbing scrutiny loses.

**Q7.** What's the practical test for whether a pay rationale survives contact?
...
> defensible, the check confirms you and you're better off than before.

**Q8.** What's the strongest counter-argument to "your pay story is already being audited by a model"?

- A. That most candidates don't actually use AI for negotiation preparation
- B. That the module's own Lesson 2 undercuts it — an instrument that gives inconsistent answers, shifts with version and framing, and confidently prices fictional universities isn't an audit, and redesigning around it lets an unreliable instrument set your standard ✓
- C. That institutional investors are legally required to use human analysts for voting decisions
- D. That pay decisions are too context-dependent for any external analysis to evaluate

> **B.** It's strongest because the module concedes the premise itself. The position you owe is
> how a sound structure plus a willingness to say "that number is wrong" compares to defensive
> redesign.
