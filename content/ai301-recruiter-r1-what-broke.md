# AI 301 · Recruiter · Module 1 — What broke

**Course:** AI 301 · The Specialist — Recruiting / TA track · Module 1 of 7
**Estimated time:** 25 min content · 10 min exercise · 20 min applied activity
**Prerequisite:** AI 101 and AI 201 · this track assumes you can already draft a JD, summarize a debrief, and build a market map with AI
**Position in the track:** the diagnosis, and the inoculation

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> Every volume figure and detection statistic is **[V]** volatile layer. The symmetry rule is
> stable and will outlive all of them.
...
and detection is the one response that makes your position worse.
...
4. Recognize the market conditions that make an AI purchase feel urgent, and price that urgency
   accurately.
5. Audit a live requisition for what each stage would cost someone faking it.
...
track is designed to be usable by someone who spends nothing.
...
stop pretending it was ever a signal stage. Your position has to engage that.

## Applied activity — "Signal audit"
...
stage you would redesign first.

## Knowledge check — 6 questions

*Unlocks after the applied activity is submitted. Retakes are free and unlimited.*

**Q1.** What is the harder problem created by AI-assisted applications?

- A. The volume increase, which exceeds recruiter capacity
- B. The information content of existing screens fell to zero while the screens stayed the same ✓
- C. Candidates misrepresent their qualifications more often than before
...
**Q2.** Why does the symmetry rule say candidates gain capability faster than recruiters?

- A. Candidates adopt new tools earlier than enterprises can procure them
- B. Consumer AI tools are more capable than enterprise recruiting tools
- C. Their capability compounds per application while yours divides across a pool that grew 412% ✓
- D. Recruiters are constrained by compliance requirements candidates don't face

> **C.** It's arithmetic, not attitude. A candidate can spend an hour on one application; you have
> minutes per applicant against a much larger pool. A is often true and is a weaker, temporary
...
> **B.** You are being sold a capability whose error rate nobody publishes. A invents the very
> figure the lesson says doesn't credibly exist — which is the trap.

**Q4.** Why is a detection response a screening decision rather than a technical control?
...
- A. Candidates applying to many roles simultaneously
- B. Non-native English speakers, neurodivergent candidates, and anyone who prepared unusually hard ✓
- C. Candidates using the least sophisticated AI tools
- D. Early-career candidates with limited work history

> **B.** Which makes it a screening criterion with disparate impact and no validation study,
> applied to protected populations — and note the third group is a trait you claimed to want.

**Q6.** How have hiring teams actually responded to AI-assisted candidates? `[V]`

- A. The majority deployed dedicated detection software
- B. Most made no changes to their process
