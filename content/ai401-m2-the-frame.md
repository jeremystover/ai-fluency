# AI 401 · The Translator · Module 2 — The frame

**Course:** AI 401 · The Translator · Module 2 of 10
**Estimated time:** 35 min content · 10 min exercise · 35 min applied activity
**Prerequisite:** Module 1 — it names the unit you run this on
**Position in the course:** the longest module, and what every module after it applies

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> Lesson 1's change typology is **[V]** because its provenance matters and one adjacent claim did
> not survive verification. The seven steps and the invariance demonstration are stable, and they
> are the part you keep.
...
you should be able to check the argument against the real document rather than a remembered one.
...
actually decides when the trigger fires, and it will frequently not be you. That isn't a failure
of the exercise. **It is the exercise telling you which instrument the situation requires** — and
the rest of this course is largely about what you do when the answer to Step 7 is somebody else.
...
Change management has a well-attested distinction at its center, and it decides what you're
allowed to promise.
...
That is the lesson, and here's why it costs you. A roadmap for a destination you can't
...
> would be true by now against what's true now. You are not looking for whether it was wrong.
> You're looking for **whether anyone ever went back and said so** — because the cost of a
> credibility loan is only paid when someone notices, and organizations are often too polite to
> notice out loud. The unpaid ones are worse. They teach people that plans are decorative.
...
beats a claim you have to trust.

## Lesson 2 · The seven steps
...
spec for a problem you don't have.
...
4 is entirely about this step because it's the one people write badly.
...
## Lesson 3 · The same seven rows, three altitudes

You'll reasonably suspect that a framework this general dilutes at the top or the bottom. Here
it's at three altitudes at once, on real examples. Read down the columns, then across the rows.
...
**The columns change scope. The rows do not change at all.** That is the point, and seeing it's
...
above them answers with a compound — me and someone whose calendar I don't control. **That is the
normal case at this rung, and it's what the rest of this course is for.**

## Lesson 4 · What makes a trigger real

Step 6 is where good frames go to die, because most people write a trigger that can't fire.

**A real trigger has three properties.**

**Observable.** Someone can look at something and say yes or no without a debate about
interpretation. "Quality declines" isn't observable. "Two handoff errors in a sprint" is. The
...
are real; only one gives you time.
...
- **If no condition would make you replan, you've written a hope.**

## Take a position

**The claim:** *"A roadmap for a destination you can't specify is a credibility loan, and you
...
version cuts deeper: **this module may be teaching an epistemically superior posture that's
...
and if it's a date, what you've decided the loan is worth.

## Applied activity — "The frame, at your altitude"
...
**Q1.** What distinguishes transformational from transitional change?

- A. Transformational change affects more people
- B. Transformational change has a future state that's unknown at the outset and emerges as you go, so it can't be planned as a linear route ✓
- C. Transformational change requires executive sponsorship
- D. Transformational change takes longer to complete

> **B.** Transitional change has a destination you can specify in detail before you begin, which is
> what licenses a route, a sequence, and a date. AI adoption is the other kind.

**Q2.** Why does the module call a roadmap for an unspecifiable destination a "credibility loan"?

- A. Because it commits budget that may not be available later
- B. Because you gain the room's confidence today in exchange for being visibly wrong in a named quarter — and at this rung, belief is your only instrument ✓
- C. Because roadmaps are usually written by people who will have moved on
- D. Because it transfers risk from the executive team to the People function

> **B.** The first miss is survivable. The second converts everything you say afterwards into
> something people discount before you finish saying it.
...
> **B.** "New starters find out what already failed here within their first month" is a spec. "A
> mentorship program with monthly check-ins" is a drawing, and it forecloses the eleven better
> answers you would only find by trying.

**Q5.** What does the three-altitude table demonstrate about the framework?

- A. That different altitudes need different frameworks
- B. That the columns change scope while the rows don't change at all ✓
- C. That enterprise-level planning is fundamentally harder than team-level planning
- D. That the framework works best at the function-head altitude

> **B.** The dissolving row is also the same event at three sizes — in every column something that
> used to force two parties into contact stopped forcing it.

**Q6.** According to the module, why does the trigger row get harder as you climb altitudes?

- A. Because senior leaders have less time to monitor conditions
- B. Because higher-altitude conditions are inherently less measurable
- C. Because the higher the altitude, the more the trigger depends on someone telling you ✓
- D. Because enterprise metrics are reported on longer cycles

> **C.** Which is why the function-head trigger is the best-designed of the three: a 30% drop in
> consultation volume is visible in the COE's own calendar without anyone's cooperation.
...
- A. It means the framework was run at the wrong altitude
- B. It means the artifact should be escalated before it's written
- C. It is the normal case at this rung, and it tells you which instrument the situation requires ✓
- D. It means the learner lacks the standing to complete the exercise

> **C.** Only the team-lead column answers "me" alone; everyone above answers with a compound. The
> rest of the course is largely about what you do when Step 7 names somebody else.
...
- Builds on Module 1's load-path model. Assumes 201's shipped build only as evidence that the
  learner has specified something before.
