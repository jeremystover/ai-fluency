# AI 401 · The Translator · Module 8 — Designed need

**Course:** AI 401 · The Translator · Module 8 of 10
**Estimated time:** 25 min content · 10 min exercise · 30 min applied activity
**Prerequisite:** Module 7 — its last lesson is this module's premise
**Position in the course:** the module with no market equivalent, and the one most likely to be misread

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> Lessons 1 and 2 are **[V]** volatile layer — they carry one study, stated with its sample twice
> because the sample is unusual and matters. The mechanism in Lessons 3 and 4 is stable.
...
## Lesson 2 · The rest of the same study **[V]**
...
> whether the equivalent transaction still happens on your team today.
...
**Q1.** Why does the module lead with the productivity and burnout findings?

- A. To establish credibility before making a harder argument
- B. Because they are the same people in the same survey, and a leader who carries only the second half will be correctly accused of telling half a story ✓
- C. Because burnout reduction is the more robust of the two findings
- D. Because wellbeing gains offset the connection losses

> **B.** 62% reporting lower stress is a large effect. If the finding were simply "AI makes people
> miserable," the politics would be easy — the difficulty is that both halves are true of the same
> population.
...
> **B.** n=2,150, seven countries, organizations of 3,500+, all active AI users. D is a real
> limitation of the study and not the answer to this question.

**Q3.** What does the module say about people using AI for advice, brainstorming, and companionship?
...
- A. Trained juniors, surfaced errors, documented process, and distributed workload
- B. Built trust at low stakes, transmitted norms that are in no document, let newcomers find mentors, and told people what existed ✓
- C. Created accountability, reinforced hierarchy, spread expertise, and built culture
- D. Validated decisions, escalated risks, shared context, and reduced duplication

> **B.** A mechanism quietly doing four jobs got optimized away because it was visibly doing one.
...
> **B.** The narrowing of access happens with no decision anyone could point to, which is what makes
> it a design problem rather than a programme problem.

**Q6.** Why is the Gen Z / Gen X gap significant to the argument?
...
> transaction that used to do it.
...
- Continues Module 7's closing mechanism directly.
