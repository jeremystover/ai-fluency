# AI 301 · Comp & Benefits · Module 1 — What this job actually is

**Course:** AI 301 · The Specialist — Comp & Benefits track · Module 1 of 6
**Estimated time:** 45 min content · 10 min exercise · 25 min applied activity
**Prerequisite:** AI 101 (or test-out) and AI 201 · this track does not re-teach either
**Position in the track:** the prediction gate — commit your numbers before you read anything

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> Almost nothing here is volatile. The five work types are a way of seeing the job, and the job
> has been this shape for longer than these tools have existed.
...
## Lesson 1 · The function, reconstructed honestly
...
functions in a company where an error is simultaneously this quiet and this durable.

## Lesson 2 · The five work types
...
## Lesson 3 · Where AI actually lands — and the finding you probably got wrong
...
argument a good structural comp person will make.

## Applied activity — "Work-type map"
...
your current stack touches.**

## Knowledge check — 8 questions

*Unlocks after the applied activity is submitted. Retakes are free and unlimited.*

**Q1.** What makes data assembly the safest genuine AI transformation in this function?

- A. It involves no sensitive data, unlike the other types
- B. Its output is verifiable against something that isn't the model — row counts, control totals, reconciliations ✓
- C. Errors in data assembly have the lowest consequences
- D. It requires no domain expertise to review

> **B.** You aren't trusting fluency, you're checking arithmetic, and nothing else in the five has
> that property. A is the opposite of true — assembly touches the most sensitive data in the
> building, which is Module 3's subject.

**Q2.** Which work type do practitioners most commonly under-predict in their own week?

- A. Data assembly, because it's tedious and easy to forget
- B. Governance, because it happens in short bursts
- C. Explanation, because analysis is what the job feels like it's about ✓
- D. Judgment, because decisions are made quickly

> **C.** Explanation hides inside "answering a question," which nobody logs as work — while
> analysis is what required the training and what practitioners identify with. That gap is why
> the module gates the prediction before Lesson 1.

**Q3.** Why does AI change explanation work more than the other types?

- A. Because explanation has the lowest accuracy requirements
- B. Because producing a clear draft for a specific audience is what these tools do well, and you already hold the raw material — your decision and its reasoning ✓
- C. Because explanation work is not subject to 101 M7's line
- D. Because explanation outputs are rarely reviewed

> **B.** The supply-the-material condition from 101 is already satisfied: you know why you decided
> what you decided. C is wrong in an important way — explaining a decision about a named person's
> pay still sits under the line; what makes it safer is visibility, not exemption.

**Q4.** A comp analysis produces a confident, well-formatted, wrong answer. Why is this function especially exposed?

- A. Because comp data is more error-prone than other HR data
- B. Because practitioners here are trained to read formatted output for shape, and shape is the thing the model always gets right ✓
- C. Because analysis outputs are rarely checked by anyone else
- D. Because comp models are more complex than other HR models

> **B.** The numeracy that makes this function capable is what makes it exposed — you read a
> formatted model the way you read a formatted sentence. That inversion is the track's
> through-line and Module 3's whole subject.

**Q5.** What can AI legitimately do in governance work?

- A. Serve as the system of record, if properly configured
- B. Attest that an approval occurred, based on the conversation log
- C. Draft documentation and check a record for completeness — but it cannot be the record, and cannot attest that something happened ✓
- D. Nothing — governance work excludes AI entirely

> **C.** Drafting and completeness-checking are real help at the edges. The centre — being the
> record, or vouching that an event occurred — is a category error, and in fiduciary contexts a
> dangerous one.

**Q6.** Why does the module call the five-type map a "buying instrument"?

- A. Because vendors price their products by work type
- B. Because vendors sell by product category, which maps to their engineering rather than to your hours — so the question is which type a product touches and whether that's where your week is ✓
- C. Because it produces a budget estimate for AI spend
- D. Because procurement requires a documented evaluation framework

> **B.** In that order the evaluation answers itself. In the other order you're assessing a demo
> against a job description you've never written down.

**Q7.** What does the module identify as the single most common mismatch in AI buying for this function?

- A. Buying benefits tools when the pain is in compensation
- B. Buying enterprise platforms when point solutions would do
- C. Buying a product that speeds up analysis when the bottleneck is explanation ✓
- D. Buying tools that duplicate existing HRIS capability

> **C.** And it's common for a legible reason: analysis is what everyone thinks the job is, so
> it's what everyone builds for — including the buyer evaluating the demo.

**Q8.** What's the strongest counter-argument to the module's claim about explanation?

- A. That explanation work is too varied for AI to help with reliably
- B. That explanation volume is a symptom of upstream design failure — better bands, a documented philosophy and trained managers would eliminate most of it, so getting faster at explaining optimizes structural debt instead of fixing it ✓
- C. That analysis work will grow as data availability increases
- D. That explanation is properly the manager's job rather than the comp team's

> **B.** It's the strongest because it accepts the measurement and disputes the conclusion: the
> hours are real, and reallocating toward them may be the wrong response. A good structural comp
> person will make this argument, and a position that doesn't engage it hasn't survived contact.
...
- Builds on 101 M6 (confidence and correctness decoupled), 101 M7 (decisions about people), and
  201 M1 (the workflow audit) — none of which this track re-teaches.
