# AI 301 · Recruiter · Module 3 — The highest-leverage hour is intake

**Course:** AI 301 · The Specialist — Recruiting / TA track · Module 3 of 7
**Estimated time:** 25 min content · 10 min exercise · 25 min applied activity
**Prerequisite:** Module 2 · builds on 101 M5 (prompting as briefing)
**Position in the track:** before Module 4 — the loop inherits the scorecard

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> Almost nothing here is volatile. Intake was the highest-leverage hour before these tools
> existed; AI changed what you can produce from it, not what it's for.
...
prepare better for one conversation, and then have the nerve to challenge what you're told in it.
...
## Lesson 1 · Why the first hour is different
...
what the role actually needs. **You supply the conversation; it supplies the paperwork.**

## Lesson 3 · Challenging the spec
...
tell you that the role as specified doesn't exist in the market at that price.
...
> have a question for your hiring manager and possibly a faster search.

## Lesson 4 · Rehearse it first
...
meeting?** If nothing, the rehearsal produced confidence rather than preparation.
...
effective recruiters work exactly this way. Your position has to engage it.

## Applied activity — "Marked wrong"
...
whether you think that's alignment or disengagement.
...
> **B.** Five downstream artifacts inherit the defect, each defended by someone who wasn't in the
> original conversation. A scheduling error surfaces immediately, costs an apology, and nothing
> inherits it.

**Q2.** What test tells you a scorecard competency is real rather than an adjective?

- A. Whether the hiring manager approved it
- B. Whether it appears in the job description
- C. Whether two interviewers could independently score the same candidate and agree within a point ✓
...
> actually sits, and surfacing it at intake resolves the week-five argument before it happens.

**Q4.** A hiring manager insists on five years of experience. What's the productive move?

- A. Accept it — experience requirements are the manager's call
- B. Ask what it's a proxy for, since it's rarely about the years and the real requirement is usually narrower and easier to source ✓
- C. Point out that it may create adverse impact
- D. Propose three years as a compromise

> **B.** Usually a proxy for autonomy, surviving a specific failure, or credibility with a
> stakeholder. C is true and Module 6 covers it, but leading with the compliance argument makes
> it a fight; leading with the mechanism makes it a conversation that produces a better search.

**Q5.** Which question best surfaces the unstated deal-breaker?

- A. "What are the must-have requirements?"
- B. "What would make you say no to a candidate?"
- C. "Tell me about the last person you rejected late in a process. What was it?" ✓
- D. "How would you rank these requirements?"

> **C.** Late-stage rejections are where the real criteria live, because the stated ones had
> already been satisfied. B asks the manager to introspect about the future, which produces the
> written requirements back; C asks them to recall, which produces the truth.
...
- Builds on 101 M5 (prompting as briefing), whose brief-a-capable-stranger discipline is what
  makes the four-artifact conversion work.
