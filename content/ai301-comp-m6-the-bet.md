# AI 301 · Comp & Benefits · Module 6 — The bet

**Course:** AI 301 · The Specialist — Comp & Benefits track · Module 6 of 6
**Estimated time:** 45 min content · 10 min exercise · 35 min applied activity
**Prerequisite:** Modules 1–5 · this is where the course lands
**Position in the track:** the close, and the measurement of how far you moved

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> Lesson 2's figures are **[V]** volatile. The ladder and the funding-line discipline are stable.
...
> **A bet without a funding line is a wish.**
...
6. Account for the distance between your Module 1 prediction and your position now.

## Lesson 1 · The leverage ladder
...
attached. Which is Lesson 4.

## Lesson 3 · Why *explain* is the undervalued rung
...
to *eliminate*, not just answer faster.

## Lesson 4 · Betting honestly
...
> **B.** The requirement is organizational, not technical, which is true of most of the ladder.
> This rung is where good intentions become documented inaction.

**Q2.** Why is the leverage ladder explicitly not a maturity model?

- A. Because organizations progress through the rungs at different speeds
- B. Because you don't climb it in order and get no points for altitude — it sorts proposals by what they require, so the right rung is the highest one whose prerequisite you already have ✓
- C. Because the rungs apply differently to compensation than to benefits
- D. Because Rung 4 is unreachable for most organizations

> **B.** For most comp functions that means Rung 3, which is also the one they overlook when asked
...
> **B.** Efficiency is the frame the whole market sells in and the one frame your function can
> never win. Accepting it means arguing for your own smallness.

**Q4.** Which gain does the module say matters most to the business and is hardest to evidence? `[V]`
...
> problem as Rung 3's invisibility.
...
> **B.** Three structural reasons, none of them about the work's actual value. **A structure nobody
> can explain produces the same employee experience as a bad one.**

**Q6.** What's the honest caveat on betting the *explain* rung?

- A. That explanation quality is impossible to measure
- B. That high explanation volume can be a symptom of upstream design failure — getting better at explaining a confusing system can entrench the confusion by removing the pain that would have forced a redesign ✓
- C. That employees prefer explanations from humans
- D. That explanation work is seasonal and doesn't justify year-round investment

> **B.** Which is why a Rung 3 bet should name the questions it expects to **eliminate**, not just
> answer faster.

**Q7.** What makes a 90-day measure real rather than decorative?

- A. That it's tied to a financial outcome
- B. That it's approved by the CFO before the bet starts
- C. That it has a number, a baseline you can take this week, and you'd report it even if it moved the wrong way ✓
...
> **B.** It's strongest because it's right about pilots and wrong about scaled commitments. The
> position you owe is where the threshold sits — at what size a proposal stops being an experiment
> you can run on slack.
