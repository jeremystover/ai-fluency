# AI 301 · Recruiter · Module 7 — Arguing for your function

**Course:** AI 301 · The Specialist — Recruiting / TA track · Module 7 of 7
**Estimated time:** 25 min content · 10 min exercise · 30 min applied activity (the course close)
**Prerequisite:** the track · builds on Module 2 (the tiers) and Module 5 (the record)
**Position in the track:** the close — and where the whole course is scored

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> The trust research and market figures are **[V]**. The argument is stable.
...
One warning first, because it's the fastest way to lose this argument before you make it.
...
5. Read your calibration record across the course and say what moved.
...
highest-return two minutes available to you.

## Lesson 2 · The one-page case
...
request from "additional resource" into "reallocation," which is a much easier thing to approve.

## Lesson 3 · The headcount conversation
...
## Lesson 4 · What the function is for
...
- **The product is decisions nobody has to redo.** That's the version of the function that
  requires judgment, which is the version that survives — and the one you can now prove.
...
## Applied activity — "The case" *(the course close)*
...
"AI is changing recruiting" is not an answer to this question.

## Knowledge check — 6 questions

*Unlocks after the applied activity is submitted. Retakes are free and unlimited.*

**Q1.** Why does workslop cost a recruiter more than it costs most other functions? `[V]`

- A. Recruiters produce more written output than other functions
- B. The recipient is the hiring manager, whose trust is the input to intake — and intake is the highest-leverage hour in the function ✓
- C. Recruiting output is more likely to be publicly visible
- D. Candidates can detect AI-generated communication easily

> **B.** ~42% of recipients trust the sender less afterwards, and your recipient is the person
> whose willingness to give you forty-five honest minutes determines whether everything
> downstream works. It's a trust balance you draw down with every unread-worthy send.
...
- A. Framing it as a transformation programme with a multi-year horizon
- B. Asking for something small enough to be believed, and naming what you'd stop doing to fund it ✓
- C. Benchmarking against what competitors are doing
- D. Including vendor case studies as supporting evidence

> **B.** Small can be evaluated; large can only be believed. And naming the trade converts a
> request for additional resource into a reallocation, which is a far easier approval.

**Q4.** What's the failure mode in the headcount conversation with your team?

- A. Sharing too much detail about executive discussions
- B. False comfort — "nothing's going to change" is a sentence they'll remember when something does, and it costs the credibility you need to lead through it ✓
- C. Moving too quickly to reassign responsibilities
- D. Involving HR before the situation is clear

> **B.** The honest version has three parts: coordination is compressing, judgment work survives,
> here's how we move — and then you have to actually reallocate the freed time visibly, or the
> statement was a slogan.

**Q5.** What does the module say about the limits of evidence in the headcount conversation with an exec?
...
> changes is the shape of what survives. Overpromising here would be the same error the module
> warns against with your team.

**Q6.** What does the module say a TA function's product actually is?

- A. Filled requisitions, delivered at or below target time-to-fill
- B. Qualified pipeline delivered to hiring managers
- C. Decisions nobody has to redo ✓
- D. Candidate experience that protects the employer brand
...
- Builds on Module 2 (the tiers), Module 4 (a loop that measures something), Module 5 (the record
  that makes the case provable), and 201 M7 (measurement without theater).
