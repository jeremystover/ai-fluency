# AI 301 · Comp & Benefits · Module 2 — Reading the evidence

**Course:** AI 301 · The Specialist — Comp & Benefits track · Module 2 of 6
**Estimated time:** 45 min content · 10 min exercise · 25 min applied activity
**Prerequisite:** Module 1 · builds on 101 M2 (the vendor teardown)
**Position in the track:** before you buy anything, and before Module 3 teaches you to build

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> Every adoption figure is **[V]** volatile layer and will move each survey cycle. The teardown
> method is stable, and the point of the module is the method rather than the numbers.
...
## Lesson 2 · Roadmaps wearing trends
...
one had to be dishonest for that to happen.
...
**If we ask you to interrogate a vendor's sample and hide our own, the lesson is worthless.**

## Lesson 4 · Data that was soft before AI touched it **[V]**
...
under the first informed question.
...
> **B.** The 52-point gap between practice and intention is the informative part, and nearly every
> article describes the intention while implying the practice. D inverts the finding — planned
> investment leads on communication at 68%, which is Module 1's explanation work.

**Q2.** Which is a tell that a piece is a product roadmap presented as an industry trend?

- A. It cites a named survey with a stated sample
- B. It quotes practitioners at organizations that don't buy from the author
...
> **B.** The selection effect is the point, not the size. A vendor doesn't have to misrepresent
> anything for a case-study set to be systematically unrepresentative.
...
> **C.** Nothing you could observe would count against it. Note the distinction the activity
> insists on: unverifiable means *may be true, cannot be checked*, which is different from
> unfalsifiable and different again from false.
...
> **B.** A selection effect in who is motivated to publish, not a conspiracy. D is a real
> pressure and a weaker, more cynical version of the same point.

**Q6.** What was already true about market data before AI touched it?

- A. It was consistently biased upward by vendor incentives
- B. Match quality varies, cuts can rest on a handful of incumbents, aging assumptions are invisible, and everyone's submission goes in under deadline ✓
- C. It was accurate but presented in unhelpful formats
- D. It excluded the majority of employers in most industries

> **B.** All four are ordinary and known, and every experienced practitioner half-knows them
> while presenting to three significant figures anyway. That's the honest starting point.

**Q7.** What did AI actually change about soft market data?
...
> recommendation collapsed. Hence the discipline: carry the softness forward, at a cost of one
> sentence.
...
- Builds on 101 M2 (vendor claim teardown) and 101 M6 (confident wrongness), aimed here at a
  literature rather than a product.
