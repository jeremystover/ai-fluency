# AI 301 · People Analytics · Module 6 — Claiming it

**Course:** AI 301 · The Specialist — People Analytics track · Module 6 of 6
**Estimated time:** 35 min content · 10 min exercise · 35 min applied activity
**Prerequisite:** Modules 1–5 · this one carries the reckoning
**Position in the track:** the course lands

> `Concepts reviewed: [DATE] · Examples current as of: [DATE]`
> Lesson 1's evidence is **[V]** volatile. The rest is stable.
...
the module is about what to do next.
...
6. Account for how far you moved across the whole track.

## Lesson 1 · Adoption is the failure mode **[V]**
...
ratio is the product problem, and it is not fixed by better analysis.**

> ### Try this — 3 minutes
> Take the analysis you are proudest of from the last year. Name the decision it changed and the
> person who made it. If you can do both, that is the model for the 90-day plan.

## Lesson 3 · Trust is the residual
...
## Lesson 4 · The stakeholder who ran their own numbers
...
rather than about your position, which is the whole basis of Lesson 3.

## Lesson 5 · The bet, and what you stop
...
territory has been claimed. **Do the offering first.**
...
- **A function that arrives with five new ways to say no and nothing new to offer has made itself
  easier to route around.** Claim the territory first.
...
undeniable win when its sponsor leaves.

## Applied activity — "The 90-day plan" *(course close)*
...
is the organization or you.

## Knowledge check — 8 questions

*Unlocks after the applied activity is submitted. Retakes are free and unlimited.*

**Q1.** What is the second reading of the 15%-in-trials versus 0.29%-at-firm-level gap? `[V]`

- A. That the trial results were not replicable outside controlled conditions
- B. That the capability is real and is not reaching the organization — which is an adoption problem, and adoption problems are diagnosable ✓
- C. That firms adopted the technology too slowly to show effects within three years
- D. That the productivity gains were captured as profit rather than measured output

> **B.** Which makes the gap the largest available diagnostic opportunity in your organization rather
> than evidence that AI fails — and you are the function that diagnoses things.

**Q2.** What does the module mean by "a finding is not a product"?

- A. That findings should be delivered through tooling rather than documents
- B. That a product has a user, a moment of use, and a decision it changes, while a finding has an author and a distribution list ✓
- C. That findings must be productized to justify analytics headcount
- D. That analytical outputs should be versioned and maintained like software

> **B.** Which is why presenting attrition drivers with no decision attached changes nothing — and the
> reason is not that the audience failed to understand it.

**Q3.** How should a dashboard nobody opens be diagnosed?

- A. As a communication failure requiring training and promotion
- B. As a design problem — and the standard response of training, a comms push and a meeting reminder is what you do when you have decided the artifact is fine ✓
- C. As evidence the underlying metrics are not decision-relevant
- D. As a normal outcome, since most dashboards have low utilisation

> **B.** The instinct is to treat non-use as a user problem. C is often true downstream and is a
> consequence of the same design failure.

**Q4.** What is trust, in the module's definition?

- A. The belief that your numbers are accurate
- B. The belief that you will say something the room does not want to hear — so that your silence is informative ✓
- C. The reputation accrued from consistently meeting delivery commitments
- D. Stakeholder confidence in the analytics function's technical competence

> **B.** Everyone assumes A, and it buys less than you think. **The refusals are what make the
> assertions load-bearing** — which is why a function that never declines has said its findings mean
> nothing in particular.

**Q5.** Which erodes trust faster than a wrong number?

- A. Delivering analysis later than promised
- B. Producing what was wanted, confidence that never varies, and silence about a limitation the audience later discovers ✓
- C. Presenting findings that contradict leadership's stated strategy
- D. Using methods the audience cannot follow

> **B.** A wrong number is recoverable. Producing what was wanted — once, visibly — is remembered for
> years, and a limitation the audience discovers for itself was survivable until they discovered it.

**Q6.** An executive arrives with a more confident answer from their own analysis. What works?

- A. A detailed methods appendix demonstrating your approach is more rigorous
- B. Locate the definitional difference in one sentence, name one confound in theirs specifically, then offer what would settle it ✓
- C. Establishing your function's authority over workforce metrics before discussing the numbers
- D. Running their analysis yourself to demonstrate the error

> **B.** Nobody in the room can adjudicate a methods dispute, so it resolves on confidence — and you
> spent yours on caveats. Offering the resolution converts a status contest into a question.

**Q7.** What is the fourth term the module adds to the closing bet?

- A. The executive sponsor who will champion it
- B. The risk that would cause you to abandon the bet
- C. Which recurring report you stop publishing ✓
- D. The headcount required to sustain it

> **C.** Description is where the hours are and the least defended thing in the portfolio. A stated
> pause with a review date is the practical version — **and nearly nobody asks for it back**, which is
> information worth more than the report was.

**Q8.** What is the module's closing warning about the track as a whole?

- A. That the methods require organizational maturity most companies lack
- B. That the halt conditions and thresholds are all ways to say no, and a function arriving with five new refusals and nothing new to offer has made itself easier to route around ✓
- C. That governance work will consume the capacity freed by AI
- D. That the track's evidence will date quickly and needs re-checking

> **B.** The methods in Modules 2, 3 and 5 are only defensible in an organization where Module 4's
> territory has been claimed. **Do the offering first.**
...
- The delta reckoning — open on a contested claim, close by measuring whether the learner moved and
  whether they can account for it — is the assessment philosophy shared across all AI 301 tracks.
