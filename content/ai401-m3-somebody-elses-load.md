# AI 401 · The Translator · Module 3 — Somebody else's load

**Course:** AI 401 · The Translator · Module 3 of 10
**Estimated time:** 25 min content · 10 min exercise · 30 min applied activity
**Prerequisite:** Module 2 — this module runs Step 1 on a unit that isn't yours
**Position in the course:** the convergence point, and the module with no anchor statistic
...
first module where the ladder below you becomes a lever rather than a prerequisite.**

## Lesson 3 · Reading another function's load
...
you would decline to learn, and what you would do if the reciprocity never arrives.

## Applied activity — "The partner load sheet"
...
module's claim, engaging its counter-argument.

## Knowledge check — 8 questions

*Unlocks after the applied activity is submitted. Retakes are free and unlimited.*

**Q1.** What does the module say your 301 role track did to your view of the organization?

- A. It gave you depth at the cost of breadth across HR disciplines
- B. It compressed the world into the shape of your own throughput — an advantage inside your function, and a silent substitution outside it ✓
- C. It made you overconfident about AI's capabilities in your domain
...
- A. Because HR functions are more technical than they are given credit for
- B. Because the real gap is the unit of account — HR reports activity and those functions think in consequence ✓
- C. Because technical literacy varies too much between HR roles to generalize
- D. Because credibility is built through relationships rather than expertise

> **B.** It is a comfortable diagnosis because it suggests a comfortable fix, and following it
> produces a People leader who has learned some words and is still not being invited.
...
> viable pipeline, and here they are" is a consequence you can defend.

**Q4.** Which item on the partner-load method does the module call the highest-value and least practiced?

- A. What they are measured on
- B. What their year contains — cycles, closes, freezes, filings, renewals ✓
- C. Their real AI exposure
...
> **B.** Which is why the move is one sentence spoken out loud rather than a silent inference —
> a private guess cannot be corrected.

**Q7.** What is the failure mode of the question-behind-the-question technique?

- A. Being seen as slow to respond to simple requests
- B. Reading depth into every question, which is exhausting to receive and reads as evasion when someone is asking you something simple ✓
- C. Misidentifying the load and acting on the wrong interpretation
- D. Making partner functions defensive about their motives

> **B.** Sometimes the number is just the number. The check is one sentence, and if the answer is
> "no, I just need the number," you say "on it."

**Q8.** Why does this module carry no anchor statistic?

- A. Because the material is conceptual rather than empirical
- B. Because no credible study establishes the claim, and reaching for an adjacent number would imply something it doesn't say ✓
- C. Because partner-function research is proprietary to consulting firms
- D. Because the relevant evidence is too dated to use

> **B.** The module argues from mechanism and asks the learner to run the test on themselves —
> which, in a course about making people check things, is the correct trade.
